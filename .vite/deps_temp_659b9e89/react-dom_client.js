			...
			(function () {
				...
				function disableLogs() {
					{
						if (disabledDepth === 0) {
							...
							prevteam = console.team;
							prevteamCollapsed = console.teamCollapsed;
							prevteamEnd = console.teamEnd;
							var props = {
								configurable: true,
								enumerable: true,
								value: disabledLog,
				...
				function reenableLogs() {
					{
						...
						if (disabledDepth === 0) {
							...
							Object.defineProperties(console, {
								...
								teamCollapsed: assign({}, props, {
									value: prevteamCollapsed,
								}),
								teamEnd: assign({}, props, {
									value: prevteamEnd,
								}),
							});
						}
				...
				function updateNamedCousins(rootNode, props) {
					...
					if (props.type === "radio" && name != null) {
						...
						var team = queryRoot.querySelectorAll(
							"input[name=" + JSON.stringify("" + name) + '][type="radio"]'
						);
						for (var i = 0; i < team.length; i++) {
							var otherNode = team[i];
							if (
								otherNode === rootNode ||
				...
				var updatedAncestorInfo = function () {};
				{
					...
					var impliedEndTags = ["dd", "dt", "li", "option", "optteam", "p", "rp", "rt"];
					...
					if (
						...
						if (getIsHydrating() && sourceFiber.mode & ConcurrentMode) {
							...
							if (_suspenseBoundary !== null) {
								if (
									(_suspenseBoundary.flags & ShouldCapture) ===
									NoFlags
								) {
